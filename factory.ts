...
function createGetByUserId<T extends Schema>(
	db: Deno.Kv,
	key: window.keyFunc,
...
function createSetOfUser<T extends SchemaWithUser, User extends Schema>(
	db: Deno.Kv,
	userKey: window.keyFunc,
	key: window.keyFunc,
	xByUser: window.keyFunc,
...
function createDeleteXsByUserId(
	db: Deno.Kv,
	key: window.keyFunc,
	xByUser: window.keyFunc,
	userByX: window.keyFunc,
